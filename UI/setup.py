...
class Ui_Dialog_SetUp(object):
    def setupUi(self, Dialog_SetUp):
        ...
        Dialog_SetUp.resize(861, 615)
        Dialog_SetUp.setMinimumSize(QSize(861, 615))
        Dialog_SetUp.setMaximumSize(QSize(861, 615))
        self.verticalLayout = QVBoxLayout(Dialog_SetUp)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.scrollArea = QScrollArea(Dialog_SetUp)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 827, 1052))
        ...
        self.checkBox_cover = QCheckBox(self.groupBox)
        self.checkBox_cover.setObjectName(u"checkBox_cover")

        self.gridLayout.addWidget(self.checkBox_cover, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_danmaku, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_audio_only, 0, 6, 1, 1)

        self.checkBox_archives = QCheckBox(self.groupBox)
        self.checkBox_archives.setObjectName(u"checkBox_archives")

        self.gridLayout.addWidget(self.checkBox_archives, 1, 0, 1, 2)

        self.checkBox_force_http = QCheckBox(self.groupBox)
        ...
        self.gridLayout.addWidget(self.checkBox_force_http, 1, 3, 1, 2)

        self.checkBox_mt = QCheckBox(self.groupBox)
        self.checkBox_mt.setObjectName(u"checkBox_mt")
        self.checkBox_mt.setFont(font)
        self.checkBox_mt.setChecked(True)

        self.gridLayout.addWidget(self.checkBox_mt, 1, 5, 1, 2)

        self.checkBox_download_all = QCheckBox(self.groupBox)
        self.checkBox_download_all.setObjectName(u"checkBox_download_all")

        self.gridLayout.addWidget(self.checkBox_download_all, 2, 0, 1, 3)

        self.checkBox_p_video = QCheckBox(self.groupBox)
        self.checkBox_p_video.setObjectName(u"checkBox_p_video")

        self.gridLayout.addWidget(self.checkBox_p_video, 2, 3, 1, 2)

        self.lineEdit_p_video = QLineEdit(self.groupBox)
        self.lineEdit_p_video.setObjectName(u"lineEdit_p_video")

        self.gridLayout.addWidget(self.lineEdit_p_video, 2, 5, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_sub_only, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_video_only, 0, 5, 1, 1)
        ...
        self.horizontalLayout_6.addWidget(self.checkBox_skip_ai)
        ...
        self.horizontalLayout_6.addWidget(self.checkBox_skip_mux)
        ...
        self.horizontalLayout_6.addWidget(self.checkBox_skip_cover)
        ...
        self.horizontalLayout_6.addWidget(self.checkBox_skip_subtitle)
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.groupBox_9)
        ...
        self.horizontalLayout_2.addWidget(self.checkBox_hs)
        ...
        self.horizontalLayout_2.addWidget(self.checkBox_ia)

        self.checkBox_show_all = QCheckBox(self.groupBox_9)
        self.checkBox_show_all.setObjectName(u"checkBox_show_all")

        self.horizontalLayout_2.addWidget(self.checkBox_show_all)
        ...
        self.label_bbdown = QLabel(self.scrollAreaWidgetContents)
        self.label_bbdown.setObjectName(u"label_bbdown")
        self.label_bbdown.setFont(font)

        self.horizontalLayout_3.addWidget(self.label_bbdown)

        self.lineEdit_bbdown = QLineEdit(self.scrollAreaWidgetContents)
        self.lineEdit_bbdown.setObjectName(u"lineEdit_bbdown")

        self.horizontalLayout_3.addWidget(self.lineEdit_bbdown)

        self.pushButton_bbdown = QPushButton(self.scrollAreaWidgetContents)
        self.pushButton_bbdown.setObjectName(u"pushButton_bbdown")
        self.pushButton_bbdown.setFont(font)

        self.horizontalLayout_3.addWidget(self.pushButton_bbdown)

        self.horizontalSpacer_3 = QSpacerItem(24, 18, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_3.addItem(self.horizontalSpacer_3)

        self.checkBox_ffmpeg = QCheckBox(self.scrollAreaWidgetContents)
        self.checkBox_ffmpeg.setObjectName(u"checkBox_ffmpeg")
        self.checkBox_ffmpeg.setFont(font)
        self.checkBox_ffmpeg.setMouseTracking(True)
        self.checkBox_ffmpeg.setChecked(True)

        self.horizontalLayout_3.addWidget(self.checkBox_ffmpeg)

        self.lineEdit_ffmpeg = QLineEdit(self.scrollAreaWidgetContents)
        self.lineEdit_ffmpeg.setObjectName(u"lineEdit_ffmpeg")
        self.lineEdit_ffmpeg.setReadOnly(False)

        self.horizontalLayout_3.addWidget(self.lineEdit_ffmpeg)

        self.pushButton_ffmpeg = QPushButton(self.scrollAreaWidgetContents)
        ...
        self.horizontalLayout_3.addWidget(self.pushButton_ffmpeg)
        ...
        self.horizontalLayout_16.addWidget(self.checkBox_aria2c_path)
        ...
        self.horizontalLayout_16.addWidget(self.lineEdit_aria2c_path)

        self.pushButton_aria2c = QPushButton(self.groupBox_12)
        self.pushButton_aria2c.setObjectName(u"pushButton_aria2c")

        self.horizontalLayout_16.addWidget(self.pushButton_aria2c)
        ...
        self.horizontalLayout_17.addWidget(self.checkBox_aria2c_proxy)
        ...
        self.horizontalLayout_17.addWidget(self.lineEdit_aria2c_proxy)
        ...
        self.horizontalLayout_18.addWidget(self.checkBox_aria2c_args)
        ...
        self.horizontalLayout_18.addWidget(self.lineEdit_aria2c_args)
        ...
        self.horizontalLayout_5.addWidget(self.checkBox_token)
        ...
        self.horizontalLayout_7.addWidget(self.checkBox_mp4box)
        ...
        self.horizontalLayout_7.addWidget(self.checkBox_mp4box_path)
        ...
        self.horizontalLayout_7.addWidget(self.lineEdit_mp4box_path)

        self.pushButton_mp4box = QPushButton(self.groupBox_4)
        self.pushButton_mp4box.setObjectName(u"pushButton_mp4box")

        self.horizontalLayout_7.addWidget(self.pushButton_mp4box)
        ...
        self.verticalLayout_5 = QVBoxLayout(self.groupBox_13)
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_enable_proxy)
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_host)
        ...
        self.horizontalLayout_4.addWidget(self.checkBox_ep_host)
        ...
        self.horizontalLayout_4.addWidget(self.lineEdit_ep_host)
        ...
        self.checkBox_f_r_host = QCheckBox(self.groupBox_13)
        self.checkBox_f_r_host.setObjectName(u"checkBox_f_r_host")
        self.checkBox_f_r_host.setChecked(True)

        self.horizontalLayout_8.addWidget(self.checkBox_f_r_host)

        self.checkBox_allow_pcdn = QCheckBox(self.groupBox_13)
        self.checkBox_allow_pcdn.setObjectName(u"checkBox_allow_pcdn")

        self.horizontalLayout_8.addWidget(self.checkBox_allow_pcdn)

        self.horizontalSpacer_5 = QSpacerItem(71, 20, QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout_8.addWidget(self.checkBox_upos_host)

        self.lineEdit_upos_host = QLineEdit(self.groupBox_13)
        self.lineEdit_upos_host.setObjectName(u"lineEdit_upos_host")

        self.horizontalLayout_8.addWidget(self.lineEdit_upos_host)
        ...
        self.horizontalLayout_14.addWidget(self.checkBox_tv_host)

        self.lineEdit_tv_host = QLineEdit(self.groupBox_13)
        self.lineEdit_tv_host.setObjectName(u"lineEdit_tv_host")

        self.horizontalLayout_14.addWidget(self.lineEdit_tv_host)

        self.horizontalSpacer_6 = QSpacerItem(37, 20, QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout_14.addWidget(self.checkBox_area)
        ...
        self.horizontalLayout_14.addWidget(self.lineEdit_area)
        ...
        self.verticalLayout_2 = QVBoxLayout(self.groupBox_11)
        ...
        self.horizontalLayout_10.addWidget(self.checkBox_ua)

        self.horizontalSpacer = QSpacerItem(76, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout_10.addWidget(self.lineEdit_ua)
        ...
        self.horizontalLayout_11.addWidget(self.checkBox_language)

        self.horizontalSpacer_2 = QSpacerItem(32, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout_11.addWidget(self.lineEdit_language)
        ...
        self.horizontalLayout.addWidget(self.checkBox_F)
        ...
        self.horizontalSpacer_4 = QSpacerItem(48, 20, QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout.addWidget(self.checkBox_M)
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_val)

        self.plainTextEdit = QPlainTextEdit(self.groupBox_7)
        self.plainTextEdit.setObjectName(u"plainTextEdit")
        self.plainTextEdit.setMinimumSize(QSize(0, 150))
    ...
    def retranslateUi(self, Dialog_SetUp):
        ...
        self.checkBox_cover.setText(QCoreApplication.translate("Dialog_SetUp", u"\u4ec5\u4e0b\u8f7d\u5c01\u9762", None))
        self.checkBox_danmaku.setText(QCoreApplication.translate("Dialog_SetUp", u"\u4ec5\u4e0b\u8f7d\u5f39\u5e55", None))
        ...
        self.checkBox_download_all.setText(QCoreApplication.translate("Dialog_SetUp", u"\u5bfc\u51fa\u89c6\u9891\u5730\u5740\u540e\u4e0b\u8f7dUP\u4e3b\u7684\u5168\u90e8\u6295\u7a3f", None))
        self.checkBox_p_video.setText(QCoreApplication.translate("Dialog_SetUp", u"\u6279\u91cf\u4e0b\u8f7d\u89c6\u9891\u95f4\u9694", None))
        self.lineEdit_p_video.setInputMask("")
        self.lineEdit_p_video.setText(QCoreApplication.translate("Dialog_SetUp", u"10", None))
        self.lineEdit_p_video.setPlaceholderText("")
        ...
        self.checkBox_show_all.setText(QCoreApplication.translate("Dialog_SetUp", u"\u5c55\u793a\u6240\u6709\u5206P\u6807\u9898", None))
        self.label_bbdown.setText(QCoreApplication.translate("Dialog_SetUp", u"BBDownT\u4f4d\u7f6e", None))
        ...
        self.pushButton_aria2c.setText(QCoreApplication.translate("Dialog_SetUp", u"\u6d4f\u89c8", None))
#if QT_CONFIG(tooltip)
        ...
        self.checkBox_mp4box_path.setText(QCoreApplication.translate("Dialog_SetUp", u"\u8bbe\u7f6eMP4Box\u8def\u5f84", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(whatsthis)
        self.pushButton_mp4box.setText(QCoreApplication.translate("Dialog_SetUp", u"\u6d4f\u89c8", None))
        ...
        self.checkBox_f_r_host.setText(QCoreApplication.translate("Dialog_SetUp", u"\u5f3a\u5236\u66ff\u6362\u4e0b\u8f7d\u670d\u52a1\u5668host", None))
        self.checkBox_allow_pcdn.setText(QCoreApplication.translate("Dialog_SetUp", u"\u4e0d\u66ff\u6362PCDN\u57df\u540d", None))
        self.checkBox_upos_host.setText(QCoreApplication.translate("Dialog_SetUp", u"\u81ea\u5b9a\u4e49upos\u670d\u52a1\u5668", None))
        self.checkBox_tv_host.setText(QCoreApplication.translate("Dialog_SetUp", u" \u81ea\u5b9a\u4e49tv\u7aef\u63a5\u53e3\u8bf7\u6c42Host", None))
